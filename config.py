...
ALIVE_PIC = getenv("ALIVE_PIC", "https://telegra.ph/file/a32783a91999e9774054a.jpg")
OWNER_ID = int(getenv("OWNER_ID", "6666371804"))
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", "6666371804").split(" ")))
