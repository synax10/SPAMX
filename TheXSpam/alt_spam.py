...
async def pspam(client: Client, message: Message):
    cid = message.chat.id
    if int(cid) in GROUP:
        await message.reply_text("» ꜱᴏʀʀʏ, ᴛʜɪꜱ ɪꜱ ⚡️𝐒 𝐘 𝐍 𝐀 𝐗⚡️ ᴘʀᴏᴛᴇᴄᴛᴇᴅ ɢʀᴏᴜᴘ.")
        return
...
async def hang(xspam: Client, message: Message): 
    ...
    if int(message.chat.id) in GROUP:
        await message.reply_text("__DON'T HANG HERE MERI JAAN__")
        return
